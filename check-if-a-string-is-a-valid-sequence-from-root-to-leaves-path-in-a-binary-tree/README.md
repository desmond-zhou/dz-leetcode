<h2>1430. Check If a String Is a Valid Sequence from Root to Leaves Path in a Binary Tree</h2><h3>Medium</h3><hr><div><p>Given a binary tree where each path going from the root to any leaf form a <strong>valid sequence</strong>, check if a given string&nbsp;is a <strong>valid sequence</strong> in such binary tree.&nbsp;</p>
